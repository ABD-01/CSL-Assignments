...
int main()
{
    ...
    printf("%-25s: ", "The Linked List - 1 "); printLinkedList(head1);
    printf("%-25s: ", "The Linked List - 2 "); printLinkedList(head2);

    res = merge(&head1, &head2);

    printf("%-25s: ", "The Intersected List "); printLinkedList(res);
